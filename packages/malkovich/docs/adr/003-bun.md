...
- [ADR-001](./001-monorepo.md): Monorepo structure works well with Bun workspaces
- [ADR-007](./007-bun-serve.md): Validated Bun choice by adopting Bun.serve
- [ADR-010](./010-oxlint.md): Continues pattern of modern Rust-based tooling
- [ADR-011](./011-css.md): Uses Bun's CSS bundling capabilities
