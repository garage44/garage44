...
- [ADR-003](./003-bun.md): TypeScript usage and developer experience focus
- [ADR-004](./004-preact-ws.md): Frontend architecture using TypeScript
- [ADR-001](./001-monorepo.md): Package boundaries - common utilities vs app-specific code
