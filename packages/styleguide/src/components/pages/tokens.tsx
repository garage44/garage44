        ...
        <section class="token-section">
            ...
            <div class="color-grid">
                {[0, 1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                    <div key={i} class="color-swatch">
                        <div class="color-swatch__color" style={`background: var(--surface-${i})`}></div>
            ...
            <div class="color-grid">
                {[0, 1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                    <div key={i} class="color-swatch">
                        <div class="color-swatch__color" style={`background: var(--primary-${i})`}></div>
                        <div class="color-swatch__label">
                            <code>--primary-{i}</code>
                        </div>
                    </div>
            ...
            <div class="color-grid">
                {[0, 1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                    <div key={i} class="color-swatch">
                        <div class="color-swatch__color" style={`background: var(--success-${i})`}></div>
                        <div class="color-swatch__label">
                            <code>--success-{i}</code>
                        </div>
                    </div>
            ...
            <div class="color-grid">
                {[0, 1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                    <div key={i} class="color-swatch">
                        <div class="color-swatch__color" style={`background: var(--danger-${i})`}></div>
                        <div class="color-swatch__label">
                            <code>--danger-{i}</code>
                        </div>
                    </div>
            ...
            <div class="color-grid">
                {[0, 1, 2, 3, 4, 5, 6, 7, 8].map(i => (
                    <div key={i} class="color-swatch">
                        <div class="color-swatch__color" style={`background: var(--warning-${i})`}></div>
                        <div class="color-swatch__label">
                            <code>--warning-{i}</code>
                        </div>
                    </div>
            ...
            <div class="spacing-scale">
                {[
                    ...
                    <div key={name} class="spacing-item">
                        <div class="spacing-visual" style={`width: var(${name}); height: var(${name})`}></div>
            ...
            <div class="radius-scale">
                {[
                    ...
                    <div key={name} class="radius-item">
                        <div class="radius-visual" style={`border-radius: var(${name})`}></div>
